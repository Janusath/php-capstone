            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                if(isset($_SESSION['success'])){
                  ...
                  echo '<div class="alert alert-success mt-4" role="alert">'.$_SESSION["success"].'</div>'; unset($_SESSION["success"]);
                }

                elseif(isset($_SESSION['error'])){

                  echo '<div class="alert alert-danger mt-4" role="alert">'.$_SESSION["error"].'</div>'; unset($_SESSION["error"]);
