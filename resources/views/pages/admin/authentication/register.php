...
if (isset($_SESSION['id'])) {
  // header("Location: http://localhost/project/index.php"); // Already logged in, redirect to dashboard
  // $rootUrl = "http://" . $_SERVER['HTTP_HOST'] . "/project";
...
if($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['submit'])){
  ...
  if(mysqli_stmt_execute($stmt)){
    ...
    $_SESSION['error']="Registration faild. Please try again";
                ...
                <form class="row g-3 needs-validation" method="post" novalidate>
                  <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <button class="btn btn-primary w-100" name="submit" value="submit" type="submit">Create Account</button>
                    </div>
                    <div class="col-12">
